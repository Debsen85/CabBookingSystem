...
<body>
	...
	<div id="loading"
		...
		<img id="loading-image" style="margin-top: 13%; width: 20%;"
			...
			alt="Loading..." />
		<h2 style="text-align: center; color: white">Checking your past travels, be patient!</h2>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table>
						...
						<tr>
							<td colspan="2" align="center"><h4 style="color: red">You haven't started your journey with us!</h4></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><hr></td>
						</tr>
