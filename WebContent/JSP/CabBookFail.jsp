...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/CSS/CabBookFail.css">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table>
							...
							<tr>
								<td colspan="2" align="center"><h4 style="color: red">Sorry, if we caused any inconvinience!</h4></td>
							</tr>
							<tr>
								<td colspan="2" align="center"><hr></td>
							</tr>						
