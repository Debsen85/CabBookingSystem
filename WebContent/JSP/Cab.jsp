...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/CSS/Cab.css">
...
<body>
	...
	<div id="loading" style="width: 100%; height: 150%; position: absolute; background-color: black; margin: auto; text-align: center;">
		...
		<h2 style="text-align: center; color: white">Setting up your journey details!</h2>
	</div>
	<div id="Big" style="visibility: hidden">
	  ...
	  <div class="Back">
	    <img src="${pageContext.servletContext.contextPath}/IMAGES/Back7.jpg" style="width: 100%" class="img">
	    <div class="main">
	      <div class="crazy">
	        <div class="text">
	          <h1>Book your cab!</h1>
	          <hr><br>
	          <form method="post" action="http://localhost:8080/TheDemo/S4" style="text-align: center;">
	            <table>
	              <tr>
	                <td colspan="3" align="center"><img src="${pageContext.servletContext.contextPath}/IMAGES/Cab.jpg" width=40% style="border-radius: 50%; text-align: center;" /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-user icon"></i></td><td> <strong>Name</strong></td><td>:&nbsp;&nbsp;&nbsp;<input value="${Name}" type="text" name="Name" placeholder="Name" id="inp1" required /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-map-marker"></i></td><td> <strong>Pick-up Location</strong></td><td>:&nbsp;&nbsp;&nbsp;<input type="text" name="PickUpLocation" placeholder="Pick-up Location" id="inp2" required/></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-map-marker"></i></td><td> <strong>Drop-off Location</strong></td><td>:&nbsp;&nbsp;&nbsp;<input type="text" name="DropOffLocation"  placeholder="Drop-off Location" id="inp3" required /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-tag"></i></td><td> <strong>Landmark</strong></td><td>:&nbsp;&nbsp;&nbsp;<input type="text" name="Landmark" placeholder="Landmark" id="inp4" required /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-map"></i></td><td> <strong>Distance</strong></td><td>:&nbsp;&nbsp;&nbsp;<input type="text" name="Distance" placeholder="Distance" id="inp5" required /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>
	              <tr>
	                <td><i class="fa fa-clock-o"></i></td><td> <strong>Duration</strong></td><td>:&nbsp;&nbsp;&nbsp;<input type="text" name="Duration" placeholder="Duration" id="inp6" required /></td>
	              </tr>
	              <tr>
	                <td colspan="3" align="center"><hr></td>
	              </tr>              
	              <tr>
	                <td colspan="3" align="center"><input type="submit" value="Search" name="submit" id="But1"/></td>
	              </tr>
	            </table>
	          </form>
	        </div>
	  ...
	  <div id="myModal2" class="modal">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form method="post" action="http://localhost:8080/TheDemo/S3" onsubmit="return MasterValidate()">
	          <table>
	            <tr>
	            ...
	            <tr class="Adios">
	              <td colspan="3" align="center"><button name="PasswordChange" id="But1" onclick="Appear()">Change Password</button></td>
	            </tr>
	            <tr class="Adios">
					<td colspan="3" align="center"><hr></td>
				</tr>
				<tr class="Bonjour" style="display: none">
				...
				<tr class="Bonjour" style="display: none">
					<td colspan="3" align="center"><input type="submit"	value="Confirm Changes" name="submit" id="But2" /></td>
				</tr>
	          </table>
	        </form>
	        <form action="${pageContext.servletContext.contextPath}/JSP/CabJourneySuccess.jsp" method="post"><input style="margin-left: 27.5%" type="submit" value="Previous Travels" name="submit" id="But2" /></form>
	      </div>
	    </div>
	  </div>
	</div>
</body>
<script type="text/javascript" src="${pageContext.servletContext.contextPath}/JS/Password.js"></script>
