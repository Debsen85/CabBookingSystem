...
<body>
	...
	<div id="loading" style="width: 100%; height: 150%; position: absolute; background-color: black; margin: auto; text-align: center;">
		...
		<h2 style="text-align: center; color: white">Verifying sign up details!</h2>
	</div>
	<div id="Big" style="visibility: hidden">
		<div id="d2">
			<ul>
				<li><a href="${pageContext.servletContext.contextPath}/JSP/IndexLog.jsp" class="active1"> Home <i class="fa fa-home"></i></a></li>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table>
							...
							<tr>
								<td colspan="2" align="center"><h4 style="color: green">Signed in Successfully!</h4></td>
							</tr>
							<tr>
								<td colspan="2" align="center"><hr></td>
							</tr>						
