...
<body>
	...
	<div id="loading">
		...
		<h2 style="text-align: center; color: white">Cab is booked, wait for 20 seconds for it to arrive!</h2>
	</div>
	<div id="Big" style="visibility: hidden">
		...
		<div class="Back">
			<img src="<%=request.getContextPath()%>/IMAGES/Back11.jpg" style="width: 100%" class="img" id="Im1">			
			<div class="main">
				<h1 style="text-align: center">Thank you for using our cab services.</h1>
				<hr>	
					<div class="card" id="Hello1">
						<img src="https://media.giphy.com/media/1xVc3p8Q0MmA8unl6Y/giphy.gif" style="width:90%; border-radius: 15px"/>
						<h3>Journey Status</h3>
						<hr>					
						<p style="text-align: center;">Your cab will arrive in 20 seconds.</p>	
						<form method="post" action="http://localhost:8080/TheDemo/S10"><p><input type="submit" id="Button1" value="Cancel Ride" /></p></form>					
					</div>				
				<br>
