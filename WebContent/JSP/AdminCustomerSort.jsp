...
<body style="background: linear-gradient(to right, #efefbb, #d4d3dd);">	
	<div id="loading" style="width: 100%; height: 150%; position: absolute; background-color: black; margin: auto; text-align: center;">
		...
		<h2 style="text-align: center; color: white">Sorting customer details!</h2>
	</div>
				...
				<%
					...
					{     
						...
						if (Option.equals("ASC")) {
							Ps=Con.prepareStatement("SELECT *FROM customer ORDER BY Name ASC");
						} else {
							Ps=Con.prepareStatement("SELECT *FROM customer ORDER BY Name DESC");
						} 
